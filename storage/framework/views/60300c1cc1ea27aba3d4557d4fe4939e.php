...
<body style="font-family: 'Montserrat', sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0;">
    ...
    <footer style="background-color: #d3d3d3; color: black; text-align: center; padding: 1rem 0; width: 100%; margin-top: 3rem;">
        <div>
            <p style="margin: 0;">© 2025 Safe Space from Moepi Publishing</p>
        </div>
    </footer>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\teketeApplication\staging.teketesafespace.co.za\resources\views/emails/case-number-notification.blade.php ENDPATH**/ ?>