...
<aside class="sidebar school-admin-sidebar" id="schoolAdminSidebar">
    ...
    <ul class="sidebar-list">
        ...
        <a href="<?php echo e(url('/admin/settings')); ?>" class="sidebar-link <?php echo e(request()->is('admin/settings') ? 'active' : ''); ?>">My Profile</a>
            ...
            <!--[if BLOCK]><![endif]--><?php if(request()->is('admin/dashboard')): ?>
                <a href="#" 
...
<?php /**PATH /home/teketeq9v8o0/staging.teketesafespace.co.za/resources/views/components/school-admin-sidebar.blade.php ENDPATH**/ ?>