...
<div class="hidden md:flex justify-between items-center px-6 lg:px-20 py-4 bg-white shadow-sm">
    ...
    <div class="flex gap-8 text-[17px] text-black">
        ...
        <a href="<?php echo e(route('about-us')); ?>" class="font-bold">About Us</a>
...
<div id="mobile-menu" class="fixed inset-0 z-[60] hidden md:hidden">
    ...
    <a href="<?php echo e(route('landing-page')); ?>" class="block py-3 text-black hover:text-[#c7da30] transition-colors">Home</a>
    <a href="<?php echo e(route('about-us')); ?>" class="block py-3 text-black hover:text-[#c7da30] transition-colors">About Us</a>
    <a href="<?php echo e(route('contact-us')); ?>" class="block py-3 text-black hover:text-[#c7da30] transition-colors">Contact Us</a>
</nav>
    ...
    <div class="max-w-[1280px] mx-auto flex flex-col lg:flex-row items-center gap-12">
        ...
        <div class="flex-1 text-center lg:text-left">
            <h2 class="text-[32px] sm:text-[40px] md:text-[50px] font-extrabold text-[#333333] mb-6">
                ABOUT TEKETE SAFE SPACE
            </h2>

<!-- FIXED RESPONSIVE UNDERLINE - JUST RIGHT -->
<div class="h-[6px] bg-[#c7da30] 
    ...
    <p class="text-[17px] text-[#444444] leading-relaxed mt-9">
        ...
        Tekete Safe Space by Moepi Publishing ensures every report is handled with confidentiality and urgency.
    </p>
</section>
...
<!-- ================= WHO WE SERVE ================= -->
<section class="bg-white w-full px-6 lg:px-20 pb-12 max-w-[1280px] mx-auto grid grid-cols-1 md:grid-cols-[1fr_auto] gap-10 items-start">
...
<section class="bg-white w-full px-6 lg:px-20 pt-4 pb-4">
  ...
  <div class="space-y-10 text-gray-800 text-[16px] md:text-[17px] flex flex-col items-start w-full max-w-6xl mx-auto">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 px-6 max-w-[1280px] mx-auto text-[14px] sm:text-[16px]">
            ...
            <div class="flex flex-wrap items-center gap-4">
                <a href="https://www.youtube.com/@matauramapuputla6836" target="_blank">
                    <img src="<?php echo e(asset('images/youtube.png')); ?>" class="w-[30px] h-[30px]">
                </a>
                <a href="https://x.com/moepipublishing" target="_blank">
                    <img src="<?php echo e(asset('images/X.png')); ?>" class="w-[30px] h-[30px]">
                </a>
                <a href="https://www.linkedin.com/company/moepi-publishing/" target="_blank">
                    <img src="<?php echo e(asset('images/linkedIn.png')); ?>" class="w-[30px] h-[30px]">
                </a>
                <a href="https://www.facebook.com/MoepiPublishing" target="_blank">
                    <img src="<?php echo e(asset('images/facebook.png')); ?>" class="w-[35px] h-[30px]">
                </a>
                <a href="https://www.instagram.com/moepipublishing" target="_blank">
                    <img src="<?php echo e(asset('images/instagram.png')); ?>" class="w-[35px] h-[30px]">
                </a>
                <a href="https://www.tiktok.com/@moepipublishing" target="_blank">
                    <img src="<?php echo e(asset('images/tiktok.png')); ?>" class="w-[35px] h-[30px]">
                </a>
            </div>
        </div>
    </footer>
...
<?php /**PATH C:\Users\monye\Documents\staging.teketesafespace.co.za\resources\views/about/index.blade.php ENDPATH**/ ?>