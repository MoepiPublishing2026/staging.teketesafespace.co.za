<div x-data="{ menuOpen: false }" class="flex flex-col font-[Montserrat] bg-white min-h-screen overflow-x-hidden relative">
    ...
    <!-- NAVBAR -->
   <!-- NAVBAR -->
<header class="absolute top-0 left-0 right-0 z-50 w-full flex justify-between items-center px-6 pt-6 lg:pt-8 lg:right-[160px]">
    ...
    >
        ...
        <a href="<?php echo e(route('landing-page')); ?>" @click="menuOpen = false" class="text-black text-[17px] mb-4 hover:text-[#c7da30] transition-colors">Home</a>
...
; top:701.1;">
 ...
 <?php echo $__env->make('components.privacy-notice', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\monye\Documents\staging.teketesafespace.co.za\resources\views/livewire/landing-page.blade.php ENDPATH**/ ?>