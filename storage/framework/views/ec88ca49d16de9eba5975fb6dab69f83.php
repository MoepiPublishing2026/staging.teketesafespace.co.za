<div class="min-h-screen bg-white flex flex-col font-[Montserrat] relative w-full">
    ...
    <div class="min-h-screen bg-white flex flex-col font-[Montserrat]" style="padding-top: 140px; padding-bottom: 80px; width: 100%;">
        ...
        <div class="w-full max-w-2xl px-4 mx-auto">
            ...
            <!-- Role Selection -->
            <div class="flex justify-center items-center gap-8 mt-2 mb-8 text-black text-[15px] flex-wrap md:flex-nowrap"
...
<?php /**PATH C:\xampp\htdocs\teketeApplication\staging.teketesafespace.co.za\resources\views/livewire/admin-login-form.blade.php ENDPATH**/ ?>