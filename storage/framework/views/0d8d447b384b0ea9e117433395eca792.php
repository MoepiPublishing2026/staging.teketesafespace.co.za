        ...
        <div class="flex flex-row justify-between items-center px-4 sm:px-8 py-2"
            ...
            <div class="hidden md:flex gap-8" 
                ...
                <a href="<?php echo e(route('landing-page')); ?>" 
                 ...
                 <a href="<?php echo e(route('landing-page')); ?>#about"
                       class="transition-colors hover:!text-[#c7da30]"
                       style="color: black; text-decoration: none;">
                       About Us
                    </a>
                    <a href="<?php echo e(route('landing-page')); ?>#section"
                       class="transition-colors hover:!text-[#c7da30]"
                       style="color: black; text-decoration: none;">
                       Contact Us
                    </a>
...
<?php /**PATH /home/teketeq9v8o0/staging.teketesafespace.co.za/resources/views/livewire/passwordless-login.blade.php ENDPATH**/ ?>