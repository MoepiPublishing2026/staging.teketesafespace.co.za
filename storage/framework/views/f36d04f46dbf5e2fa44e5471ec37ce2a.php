...
<body>
    ...
    <header class="main-header">
        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Tekete Safe Space" height="50">

        <a href="<?php echo e(route('faq')); ?>" class="faq-link">
            FAQ
        </a>
    </header>
    ...
    <?php if($subscription): ?>
        <div
            ...
            <?php if($subscription->isActive()): ?>
                ...
                <span>Current Plan: <strong><?php echo e($subscription->plan_label); ?></strong></span>
                <?php if($subscription->expires_at): ?>
                    <span style="color:#888;">· Expires: <?php echo e($subscription->expires_at->format('d M Y')); ?></span>
                <?php else: ?>
            ...
            <?php elseif($subscription->isExpired()): ?>
                ...
                <span>Your <strong><?php echo e($subscription->plan_label); ?></strong> expired on
                    <?php echo e($subscription->expires_at->format('d M Y')); ?>. Please renew below.</span>
            <?php endif; ?>
        </div>
    <?php endif; ?>
    ...
    <div class="container">
        ...
        <div class="plans">
            ...
            <div class="card">
                ...
                </div> <a href="<?php echo e(route('admin.checkout', ['plan' => 'starter'])); ?>" class="btn"
                    style="<?php echo e(isset($subscription) && $subscription->plan === 'starter' && $subscription->isActive() ? 'background:var(--green);color:#000;' : ''); ?>">
                    <?php echo e(isset($subscription) && $subscription->plan === 'starter' && $subscription->isActive() ? 'CURRENT PLAN' : 'SELECT'); ?>
            ...
            <div class="card">
                ...
                </div> <a href="<?php echo e(route('admin.checkout', ['plan' => 'annual'])); ?>" class="btn"
                    style="<?php echo e(isset($subscription) && $subscription->plan === 'annual' && $subscription->isActive() ? 'background:var(--green);color:#000;' : ''); ?>">
                    <?php echo e(isset($subscription) && $subscription->plan === 'annual' && $subscription->isActive() ? 'CURRENT PLAN' : 'SELECT'); ?>
            ...
            <div class="card">
                ...
                </div> <a href="<?php echo e(route('admin.checkout', ['plan' => 'monthly'])); ?>" class="btn"
                    style="<?php echo e(isset($subscription) && $subscription->plan === 'monthly' && $subscription->isActive() ? 'background:var(--green);color:#000;' : ''); ?>">
                    <?php echo e(isset($subscription) && $subscription->plan === 'monthly' && $subscription->isActive() ? 'CURRENT PLAN' : 'SELECT'); ?>
        ...
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="dashboard-link">
            Go to dashboard
        </a>
...
<?php /**PATH /home/teketeq9v8o0/staging.teketesafespace.co.za/resources/views/admin/subscribe.blade.php ENDPATH**/ ?>