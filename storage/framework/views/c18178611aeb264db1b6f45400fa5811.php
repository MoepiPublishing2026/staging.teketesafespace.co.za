...
<?php echo $__env->make('components.school-admin-sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <div class="main-panel">
        <div class="topbar">
            <div class="profile">
                ...
                <div class="profile-avatar">
                    ...
                    <?php else: ?>
                        <span class="profile-avatar-initial"><?php echo e(strtoupper(substr(auth()->user()->name ?? 'A', 0, 1))); ?></span>
                    <?php endif; ?>
                </div>
            </div>
        </div>
        ...
        <div class="dashboard-scroll">
            <h1>False Reports Analysis - <?php echo e($school->school_name); ?></h1>
            <p class="muted subtitle">Identify patterns and suspicious activity in false reports</p>

            <!-- Statistics Cards -->
            <div class="stats-grid">
                <div class="stat-card">
                    <div class="stat-value"><?php echo e($totalFalseReports); ?></div>
                    <div class="stat-label">Total False Reports</div>
                </div>
                <div class="stat-card">
                    <div class="stat-value"><?php echo e($totalSuspiciousEmails); ?></div>
                    <div class="stat-label">Emails with 2+ False</div>
                </div>
                <div class="stat-card">
                    <div class="stat-value"><?php echo e($totalSuspiciousNames); ?></div>
                    <div class="stat-label">Names with 2+ False</div>
                </div>
                <div class="stat-card">
                    <div class="stat-value"><?php echo e($totalSuspiciousPhones ?? 0); ?></div>
            ...
            <div class="filter-tabs">
                <a href="<?php echo e(url('/admin/false-reports?action=all')); ?>" class="filter-tab <?php echo e($actionFilter === 'all' ? 'active' : ''); ?>">All Reports</a>
                <a href="<?php echo e(url('/admin/false-reports?action=email')); ?>" class="filter-tab <?php echo e($actionFilter === 'email' ? 'active' : ''); ?>">By Email</a>
                <a href="<?php echo e(url('/admin/false-reports?action=name')); ?>" class="filter-tab <?php echo e($actionFilter === 'name' ? 'active' : ''); ?>">By Name</a>
                <a href="<?php echo e(url('/admin/false-reports?action=phone')); ?>" class="filter-tab <?php echo e($actionFilter === 'phone' ? 'active' : ''); ?>">By Phone</a>
            </div>

            <?php if($actionFilter === 'email' || $actionFilter === 'all'): ?>
                <?php if(count($suspiciousEmails) > 0): ?>
                    <div class="panel">
                        <h2>Suspicious Email Patterns</h2>
                        <p class="muted section-desc">Emails with multiple false reports</p>
                        
                        <?php $__currentLoopData = $suspiciousEmails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $email => $reports): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="pattern-group">
                                <div class="pattern-header">
                                    <h3><?php echo e($email); ?></h3>
                                    <span class="pattern-count"><?php echo e(count($reports)); ?> Reports</span>
                                </div>
                                    ...
                                    <table class="reports-table">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td><strong><?php echo e($report->case_number); ?></strong></td>
                                                    <td><?php echo e($report->full_name ?? 'N/A'); ?></td>
                                                    <td><?php echo e($report->phone_number ?? 'N/A'); ?></td>
                                                    <td><?php echo e($report->abuseType->type_name ?? 'N/A'); ?></td>
                                                    <td class="desc-cell" title="<?php echo e($report->description ?? ''); ?>"><?php echo e(\Illuminate\Support\Str::limit($report->description ?? 'N/A', 60)); ?></td>
                                                    <td><?php echo e($report->created_at->format('Y-m-d')); ?></td>
                                                    <td><?php echo e($report->latest_status_reason ?? 'N/A'); ?></td>
                                                </tr>
            ...
            <?php if($actionFilter === 'name' || $actionFilter === 'all'): ?>
                <?php if(count($suspiciousNames) > 0): ?>
                    <div class="panel">
                        <h2>Suspicious Name Patterns</h2>
                        <p class="muted section-desc">Names with multiple false reports</p>
                        
                        <?php $__currentLoopData = $suspiciousNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name => $reports): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="pattern-group">
                                <div class="pattern-header">
                                    <h3><?php echo e(ucwords($name)); ?></h3>
                                    <span class="pattern-count"><?php echo e(count($reports)); ?> Reports</span>
                                </div>
                                <div class="table-wrap">
                                    <table class="reports-table">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td><strong><?php echo e($report->case_number); ?></strong></td>
                                                    <td><?php echo e($report->reporter_email ?? 'N/A'); ?></td>
                                                    <td><?php echo e($report->phone_number ?? 'N/A'); ?></td>
                                                    <td><?php echo e($report->abuseType->type_name ?? 'N/A'); ?></td>
                                                    <td class="desc-cell" title="<?php echo e($report->description ?? ''); ?>"><?php echo e(\Illuminate\Support\Str::limit($report->description ?? 'N/A', 60)); ?></td>
                                                    <td><?php echo e($report->created_at->format('Y-m-d')); ?></td>
            ...
            <?php if($actionFilter === 'phone' || $actionFilter === 'all'): ?>
                <?php if(isset($suspiciousPhones) && count($suspiciousPhones) > 0): ?>
                    <div class="panel">
                        <h2>Suspicious Phone Patterns</h2>
                        <p class="muted section-desc">Phone numbers with multiple false reports</p>

                        <?php $__currentLoopData = $suspiciousPhones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $phone => $reports): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="pattern-group">
                                <div class="pattern-header">
                    ...
                    <?php if($falseReports->count() > 0): ?>
                        <div class="table-wrap">
                            <table class="reports-table">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $falseReports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><strong><?php echo e($report->case_number); ?></strong></td>
                                            <td><?php echo e($report->full_name ?? 'N/A'); ?></td>
                                            <td><?php echo e($report->reporter_email ?? 'N/A'); ?></td>
...
<?php /**PATH /home/teketeq9v8o0/staging.teketesafespace.co.za/resources/views/school-admin-dashboard/false-reports.blade.php ENDPATH**/ ?>