<div>
    ...
    <!--    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->showSubscriptionModal ?? false): ?>
-->
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>-->
    ...
    <header
        ...
        <div class="flex flex-row justify-between items-center px-4 sm:px-8 py-2"
            ...
            <!-- Logo -->
            <div>
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Safe Space Logo" style="width: 90px; height: auto;">
            </div>
            ...
            <div class="hidden md:flex gap-8"
                ...
                <a href="<?php echo e(route('about-us')); ?>#about" class="transition-colors hover:!text-[#c7da30]"
                    style="color: black; text-decoration: none;">
                    About Us
                </a>
                <a href="<?php echo e(route('contact-us')); ?>#section" class="transition-colors hover:!text-[#c7da30]"
                    style="color: black; text-decoration: none;">
                    Contact Us
                </a>
            </div>
    ...
    <main class="flex flex-col justify-center items-center flex-1 pt-32 px-4 w-full min-h-screen">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showOtpForm): ?>
                    ...
                    <div class="flex justify-center gap-1 sm:gap-2 w-full otp-container px-2 sm:px-0">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = 0; $i < 6; $i++): ?>
                            <input type="text" maxlength="1"
                                ...
                                oninput="updateOtp()" onkeydown="moveBack(event, <?php echo e($i); ?>)"
                                id="otp-<?php echo e($i); ?>">
...
<?php /**PATH C:\xampp\htdocs\staging.teketesafespace.co.za\resources\views/livewire/passwordless-login.blade.php ENDPATH**/ ?>