<div x-data="{ menuOpen: false }" class="flex flex-col font-[Montserrat] bg-white min-h-screen overflow-x-hidden relative">
    ...
    <!-- NAVBAR -->
    <header class="absolute top-0 right-[160px] z-50 w-full flex justify-end items-center px-6 pt-6 lg:pt-8">
        <nav class="hidden lg:flex gap-8">
            <a href="<?php echo e(route('landing-page')); ?>" onclick="toggleMobileMenu()" class="text-black text-[17px] transition-colors hover:text-[#c7da30" 
                   style="font-family: 'Montserrat', sans-serif; font-size: 17px;">
                    Home
                </a>
            <a href="<?php echo e(route('about-us')); ?>" class="text-black text-[17px] transition-colors hover:text-[#c7da30]">About Us</a>
            <a href="<?php echo e(route('contact-us')); ?>" class="text-black text-[17px] transition-colors hover:text-[#c7da30]">Contact Us</a>
        </nav>

        <button @click="menuOpen = !menuOpen" class="lg:hidden focus:outline-none z-40">
        ...
        <div 
            ...
            class="fixed top-0 right-0 w-64 h-full bg-white shadow-lg flex flex-col items-start p-6 z-50"
        >
            ...
            <a href="<?php echo e(route('about-us')); ?>" @click="menuOpen = false" class="text-black text-[17px] mb-4 hover:text-[#c7da30] transition-colors">About Us</a>
            <a href="<?php echo e(route('contact-us')); ?>" @click="menuOpen = false" class="text-black text-[17px] hover:text-[#c7da30] transition-colors">Contact Us</a>
        </div>
    </header>
    <!-- HERO SECTION -->
<section class="relative flex flex-col lg:flex-row justify-between items-start px-6 sm:px-10 lg:px-16 pt-12 pb-10 overflow-hidden">

    <!-- Circle Background -->
        <div class="absolute top-[-260px] left-[-520px] w-[1250px] sm:w-[1250px] lg:w-[1250px] h-[1250px] sm:h-[1250px] lg:h-[1250px] z-0 transition-all duration-500">
            <img src="<?php echo e(asset('images/circle6.png')); ?>" 
    ...
    <!-- Hero Inner Content -->
    <div class="relative z-10 flex flex-col lg:flex-row justify-between items-start gap-5 w-full max-w-[1250px] mx-auto">

        <!-- Left: Logo + Heading -->
        <div class="flex flex-col items-start text-left space-y-2 sm:space-y-[-70px] mt-0 sm:mt-0">
            <img src="<?php echo e(asset('images/logo.png')); ?>"
                 alt="Safe Space Logo"
                 class="w-[320px] sm:w-[340px] md:w-[380px] lg:w-[460px] ml-0 transition-all duration-300 leading-tight mt-[-70px] sm:mt-[-70px]">

            <h1 class="text-[#c7da30] font-bold text-3xl sm:text-4xl md:text-5xl lg:text-[74px] leading-tight mt-2 sm:mt-2">
        ...
        <div class="flex flex-col items-center lg:items-end mt-3 lg:mt-2 w-full lg:w-auto">
            <div class="relative flex justify-center lg:justify-end w-full">
                <img src="<?php echo e(asset('images/back-pc.png')); ?>" 
                     alt="Two Students"
            ...
            <div class="flex flex-col sm:flex-col md:flex-col lg:flex-row justify-center lg:justify-end gap-4 mt-8 w-full lg:w-auto">
...
; top:701.1;">
 ...
 <?php echo $__env->make('components.privacy-notice', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\teketeApplication\staging.teketesafespace.co.za\resources\views/livewire/landing-page.blade.php ENDPATH**/ ?>