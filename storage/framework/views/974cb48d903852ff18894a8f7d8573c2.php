...
html, body {
  ...
  color: #545454 !important; background-color: white !important;
}
...
.modal-close {
    ...
    background: white !important; /* Theme blue */
...
.modal-close {
    ...
    font-weight: 400;
    border-radius: 16px;
    box-shadow: 0 3px 18px rgba(220,230,56,0.13);
...
.modal-close:hover,
.modal-close:focus {
    background:  background: linear-gradient(to right, #ebf3abff, #d7e47a);
    color: #393f00;
    border-color: #bace28;
}
...
<main id="main-content">
    <h1>Reports</h1>
  <form id="searchForm" method="GET" action="<?php echo e(url('/national-admin/reports')); ?>" style="margin-bottom: 1rem; display: flex; gap: 8px; justify-content: center; align-items: center;">
    <input 
        type="text" 
        name="case_number" 
        placeholder="Search by Case Number" 
        value="<?php echo e(request('case_number')); ?>" 
   ...
   <div class="pagination">
    ...
    <?php else: ?>
        <a href="<?php echo e($reports->previousPageUrl()); ?>" class="page-link" rel="prev">←</a>
    <?php endif; ?>
    ...
    <?php if($reports->hasMorePages()): ?>
        <a href="<?php echo e($reports->nextPageUrl()); ?>" class="page-link" rel="next">→</a>
    <?php else: ?>
        <span class="page-link" aria-disabled="true">→</span>
    <?php endif; ?>
</div>
...
<?php /**PATH C:\xampp\htdocs\teketeApp\staging.teketesafespace.co.za\resources\views/national-admin-reports/index.blade.php ENDPATH**/ ?>