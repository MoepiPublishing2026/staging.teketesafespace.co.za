...
<head>
    ...
    <title>SafeSpace School Admin Dashboard</title>
    <!-- Fonts -->
...
<form id="logout-form" action="<?php echo e(route('logout')); ?>" method="POST" style="display: none;">
    ...
    <div class="main-panel">
        ...
        <div class="dashboard-scroll" id="main-content">
           <h1>
  SafeSpace School Admin Dashboard - 
...
<section class="panel" aria-label="Filters">
    ...
    <?php endif; ?>
            ...
            <section class="extras-row" aria-label="Extra metrics">
                <div class="metric-card extras-anonymous" onclick="activateCard(this, 'anonymous')">
                ...
                <div class="metric-card extras-identified" onclick="activateCard(this, 'identified')">
                    <span class="card-title">Identified</span>
                    <div class="card-value"><?php echo e(number_format($anonymousCounts['identified'] ?? 0)); ?></div>
                </div>
                <div class="metric-card extras-abuse" onclick="activateCard(this, 'abuse-type')">
                    <span class="card-title">Abuse Types Tracked</span>
                    <div class="card-value"><?php echo e(count($abuseTypeLabels)); ?></div>
                    <span class="card-subtext"></span>
                </div>
                <div class="metric-card extras-schools" onclick="activateCard(this, 'abuse-type')">
                    <span class="card-title">Total Abuse Types</span>
                    <div class="card-value"><?php echo e($totalAbuseTypesCount ?? 0); ?></div>
                    <span class="card-subtext"></span>
                </div>
            </section>
...
function renderOverviewCharts(dataset) {
   ...
   createChart('monthlyTrendChart', {
    ...
    // Abuse Type Distribution - pie chart
     createChart('abuseTypeChart', {
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: ['#99c4d3', '#fcb825', '#00c382', '#9b57cc', '#81acef', '#38b6ff', '#ff66c4']
            }]
        },
        options: {
            responsive: true,
...
const leftColors = customColors.map(c => c);
const rightColors = customColors.map(c => c);
...
<?php /**PATH C:\xampp\htdocs\teketeApplication\staging.teketesafespace.co.za\resources\views/school-admin-dashboard/index.blade.php ENDPATH**/ ?>