                ...
                <div class="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between mb-8">
                    <div class="flex flex-col sm:flex-row sm:items-center gap-6">
                        <div class="flex-shrink-0">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($profile_picture): ?>
...
<?php /**PATH C:\xampp\htdocs\staging.teketesafespace.co.za\resources\views/livewire/admin-settings.blade.php ENDPATH**/ ?>