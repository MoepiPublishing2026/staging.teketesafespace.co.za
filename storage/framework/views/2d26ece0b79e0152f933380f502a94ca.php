    ...
    <style>
        ...
        .password-input-wrapper {
          ...
          .password-requirements {
            ...
            padding: 0.5rem 1rem;
            margin-top: 0.5rem;
            background-color: #f7ffe4; /* light green background */
        }
    </style>
</head>
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        <span class="icon-container" onclick="togglePasswordVisibility('password', this)">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="h-5 w-5 eye-icon" viewBox="0 0 20 20" fill="currentColor">
                                <path d="M10 12.5a2.5 2.5 0 100-5 2.5 2.5 0 000 5z" />
                                <path fill-rule="evenodd"
                                    d="M.661 10.322l1.642-1.996C3.993 6.002
                    ...
                    <div class="password-input-wrapper relative">
                        ...
                        <span class="icon-container" onclick="togglePasswordVisibility('password-confirm', this)">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <path d="M10 12.5a2.5 2.5 0 100-5 2.5 2.5 0 000 5z" />
                                <path fill-rule="evenodd"
                                    d="M.661 10.322l1.642-1.996C3.993 6.002 6.784
...
; top:701.1;">
    ...
    if (type === 'password') {
        icon.innerHTML = `<path d="M10 12.5a2.5 2.5 0 100-5 2.5 2.5 0 000 5z" />
...
<?php /**PATH C:\xampp\htdocs\teketeApplication\staging.teketesafespace.co.za\resources\views/auth/passwords/reset.blade.php ENDPATH**/ ?>