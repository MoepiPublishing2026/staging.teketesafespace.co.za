...
<body style="font-family: 'Montserrat', sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0;">
    <div style="max-width: 600px; margin: 20px auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
        ...
        <p>We appreciate you taking the time to report this case. We are committed to ensuring the safety and well-being
            of our community.</p>
    ...
    <footer
        style="background-color: #d3d3d3; color: black; text-align: center; padding: 1rem 0; width: 100%; margin-top: 3rem;">
        <div>
            <p style="margin: 0;">© {{ date('Y') }} Tekete SafeSpace from Moepi Publishing</p>
        </div>
    </footer>
</body>
