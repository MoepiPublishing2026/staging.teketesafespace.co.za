...
<head>
    ...
    <title>Newsletter Panel Login</title>
    ...
    <style>
        ...
        /* Flex content container that fills the space between header and footer */
        .login-content-area {
            display: flex;
        ...
        h2 { margin-top: 0; color: #c7da30; text-align: center; margin-bottom: 25px; font-weight: bold; }
...
<body class="flex flex-col min-h-screen">
    ...
    <main class="login-content-area">
        <div class="login-box">
            ...
            <form action="{{ route('newsletter.login.submit') }}" method="POST">
                @csrf
                ...
                <button type="submit" class="btn">Login to Newsletter Manager</button>
            </form>
        </div>
    </main>
    ...
    <script>
       // REPLACE ALL OF YOUR OLD MENU SCRIPT CONTENT WITH THIS:
