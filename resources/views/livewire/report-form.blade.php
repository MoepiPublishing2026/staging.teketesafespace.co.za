    ...
    <div id="mobile-menu" class="fixed inset-0 z-50 hidden md:hidden">
        ...
        <div class="fixed top-0 right-0 h-full w-64 bg-white shadow-lg transform transition-transform duration-300 ease-in-out">
            ...
            <nav class="mt-8 px-4">
                ...
                <a href="{{ route('landing-page') }}" onclick="toggleMobileMenu()" class="block py-3 text-black hover:text-[#c7da30] transition-colors" 
                   style="font-family: 'Montserrat', sans-serif; font-size: 17px;">
                    Home
                </a>
                
                <a href="{{ route('landing-page') }}#about" onclick="toggleMobileMenu()" class="block py-3 text-black hover:text-[#c7da30] transition-colors" 
                   style="font-family: 'Montserrat', sans-serif; font-size: 17px;">
                    About Us
                </a>
                <a href="{{ route('landing-page') }}#section" onclick="toggleMobileMenu()" class="block py-3 text-black hover:text-[#c7da30] transition-colors" 
                   style="font-family: 'Montserrat', sans-serif; font-size: 17px;">
                    Contact Us
                </a>
            </nav>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input type="text" wire:model.lazy="phoneNumber" id="phoneNumber"
                                class="w-full h-[50px] sm:h-[57px] border-[3px] border-[#c7da30] rounded-[6px] p-2 text-[14.8px] text-black"
                                placeholder="e.g. 0789 345 687" maxlength="15"> @error('phoneNumber') <p class="text-red-600 text-[12px]">{{ $message }}</p> @enderror
                        </div>
                    ...
                    <div class="flex items-start justify-between gap-3">
                        ...
                        <div class="flex items-center gap-2 flex-1 min-w-0">
                            @if(str_contains($file->getMimeType(), 'image/'))
                                <img src="{{ $file->temporaryUrl() }}" class="w-10 h-10 object-cover rounded border">
