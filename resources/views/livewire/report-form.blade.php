            ...
            <div class="flex gap-8" style="font-family: 'Montserrat', sans-serif; font-size: 17px; color: black;">
                ...
                <div class="md:hidden">
                    <button id="mobile-menu-button"
                        ...
                        onclick="toggleMobileMenu()"> <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
            ...
            <div class="mx-auto border-2 border-[#c6d933] rounded-[10px] bg-white w-full max-w-[640px] p-6 sm:p-10">
                <form wire:submit.prevent="submitReport" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input type="text" wire:model.lazy="phoneNumber" id="phoneNumber"
                                class="w-full h-[50px] sm:h-[57px] border-[3px] border-[#c7da30] rounded-[6px] p-2 text-[14.8px] text-black"
                                placeholder="e.g. 0789 345 687" maxlength="15"> @error('phoneNumber')
                                <p class="text-red-600 text-[12px]">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="form-group">
                        <label for="fileUpload" class="text-[12px] text-black font-semibold">Attachment
                            (Optional)</label>
                                ...
                                <ul class="list-group space-y-2">
                                    @foreach ($image as $index => $file)
                                        <li class="flex flex-col p-3 border border-gray-200 rounded-lg bg-gray-50">
                                            <div class="flex items-start justify-between gap-3">
                                                ...
                                                <div class="flex items-center gap-2 flex-1 min-w-0">
                                                    ...
                                                    @elseif(str_contains($file->getMimeType(), 'audio/'))
                                                        <svg class="w-10 h-10 text-blue-500" fill="currentColor"
                                                            viewBox="0 0 20 20">
                                                            <path
                                                                d="M10 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h3a2 2 0 002-2v-1.5a.5.5 0 011 0V9a1 1 0 01-1 1H6a1 1 0 01-1-1V7a1 1 0 011-1h3a1 1 0 011 1z" />
                                                            <path fill-rule="evenodd"
                                                                d="M3 5a1 1 0 00-2 0v10a1 1 0 002 0V5zm12 2a1 1 0 110 2h3a1 1 0 110-2h-3zM9.5 13a1.5 1.5 0 100-3 1.5 1.5 0 000 3z" />
                                                        </svg>
                                                    @else
                                                        <svg class="w-10 h-10 text-gray-500" fill="currentColor"
                                                            viewBox="0 0 20 20">
                                                            <path fill-rule="evenodd"
                                                                d="M4 4a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2H4zm12 9H5l.01-1.99L17 8v5a1 1 0 01-1 1z" />
                                                        </svg>
                                                    @endif
                                                    ...
                                                    <div class="min-w-0 flex-1 truncate">
                                                        ...
                                                        <div class="text-xs text-gray-500">
                                                            ...
                                                            <span
                                                                class="ml-1">{{ strtoupper(str_replace(['audio/', 'video/', 'image/'], '', $file->getMimeType())) }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            @elseif(str_contains($file->getMimeType(), 'video/'))
                                                <div class="mt-2 pt-2 border-t border-gray-200">
                                                    <video controls class="w-full h-24 rounded object-contain bg-black"
                                                        preload="metadata">
                                                        <source src="{{ $file->temporaryUrl() }}"
                                                            type="{{ $file->getMimeType() }}">
                                                    </video>
                                            ...
                                            <div class="mt-2 flex gap-2">
                                                <span wire:loading.remove
                                                    wire:target="newUploads,removeImage({{ $index }})"
