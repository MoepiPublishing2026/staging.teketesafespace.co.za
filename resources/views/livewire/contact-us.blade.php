        ...
        <div id="mobile-menu-slide"
            ...
            <nav class="mt-8 px-6 space-y-4 pb-8 text-[17px] font-[Montserrat]">
                ...
                <a href="{{ url('/contact-us') }}"
                    class="block py-3 font-bold text-black border-b border-gray-100">Contact Us</a>
            </nav>
        ...
        <div class="relative max-w-[1280px] mx-auto min-h-[700px]">
            ...
            <div class="relative z-20 max-w-[500px]">
                ...
                <div class="flex items-center gap-4 mb-4">
                    ...
                    <a href="mailto:support@tekete.co.za"
                        class="text-[16px] sm:text-xl text-[#000000] hover:text-[#c7da30]">
                ...
                <div class="flex items-center gap-4 mb-8">
                    <img src="{{ asset('images/email icon.png') }}" class="w-[26px] h-[18px]">
                    <a href="mailto:sales@teketesafespace.co.za"
                        class="text-[16px] sm:text-xl text-[#000000] hover:text-[#c7da30]">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <a href="https://apps.apple.com/za/app/safe-space/id6756009264" target="_blank">
                            <img src="{{ asset('images/Apple App store.png') }}"
                                class="w-[155px] h-[90px] object-contain">
                        </a>
                        ...
                        <a href="https://appgallery.cloud.huawei.com/ag/n/app/C116390043?locale=en_GB" target="_blank">
                            <img src="{{ asset('images/Huawei AppGallery.png') }}"
                                class="w-[155px] h-[60px] object-contain">
                        </a>

                    </div>

                    <img src="{{ asset('images/futuristic digital frame tech.png') }}"
                        class="w-[170px] sm:w-[300px] h-auto">
                ...
                <div class="hidden lg:flex flex-col sm:flex-row gap-6 items-center pt-2">
                    ...
                    <a href="https://apps.apple.com/za/app/safe-space/id6756009264" target="_blank">
                        <img src="{{ asset('images/Apple App store.png') }}" class="w-[155px] h-[90px] object-contain">
                    </a>
            ...
            <div class="hidden lg:block absolute right-0 top-10 z-10 pointer-events-none">
                <img src="{{ asset('images/futuristic digital frame tech.png') }}"
                    class="w-[400px] xl:w-[459px] h-auto">
            </div>
