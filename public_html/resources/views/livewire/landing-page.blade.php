...
<header class="absolute top-0 left-0 right-0 z-50 w-full flex justify-between items-center px-6 pt-6 lg:pt-8 lg:right-[160px]">
    ...
    <nav class="hidden lg:flex gap-8 ml-auto">
        <a href="{{ route('landing-page') }}" onclick="toggleMobileMenu()" class="text-black text-[17px] transition-colors hover:text-[#c7da30]" 
           style="font-family: 'Montserrat', sans-serif; font-size: 17px;">
            Home
        </a>
        <a href="{{ route('about-us') }}" class="text-black text-[17px] transition-colors hover:text-[#c7da30]">About Us</a>
        <a href="{{ route('contact-us') }}" class="text-black text-[17px] transition-colors hover:text-[#c7da30]">Contact Us</a>
    </nav>
