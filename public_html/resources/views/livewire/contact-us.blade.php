...
<img src="{{ asset('images/Google Play Store.png') }}" class="w-[155px] h-[90px] object-contain">
</a>

<a href="https://appgallery.cloud.huawei.com/ag/n/app/C116390043?locale=en_GB" target="_blank">
<img src="{{ asset('images/Huawei AppGallery.png') }}" class="w-[155px] h-[60px] object-contain">
</a>

</div>

<img src="{{ asset('images/futuristic digital frame tech.png') }}" class="w-[170px] sm:w-[300px] h-auto">
