...
<div id="mobile-menu" class="fixed inset-0 z-[60] hidden md:hidden">
    ...
    <a href="{{ route('landing-page') }}" class="block py-3 text-black hover:text-[#c7da30] transition-colors">Home</a>
    <a href="{{ route('about-us') }}" class="block py-3 text-black hover:text-[#c7da30] transition-colors">About Us</a>
    <a href="{{ route('contact-us') }}" class="block py-3 text-black hover:text-[#c7da30] transition-colors">Contact Us</a>
</nav>
...
<section class="bg-white w-full px-6 lg:px-20 pb-12 max-w-[1280px] mx-auto grid grid-cols-1 md:grid-cols-[1fr_auto] gap-10 items-start">
    ...
    <div class="flex justify-center md:justify-end">
        <img src="{{ asset('images/Students holding phone.png') }}"
